(function (app) {
   app.service('dragDropService', function (utilityService, playerService, changeService, dataLists, Notification) {
      function onDrop(event, ui) {
         ...
         var isTeam = utilityService.FirstOrDefault(dataLists.GetTeams(), function (team) { return team.id == newTeamId }) != null;
         var isTrainingGroups = utilityService.FirstOrDefault(dataLists.GetTrainingGroups(), function (team) { return team.id == newTeamId }) != null;
